...
class DashboardController
{
    public function index()
    {
        ...
        $userVip = User::where('user_vip',1)->count();
        $orderNews = Order::latest()->limit(10)->get();
        $turnOvers = User::orderBy('turn_over','desc')->limit(10)->get();
        $createdChapters = User::orderBy('chapters_created','desc')->limit(10)->get();
        $goldGiftNews = GoldGift::latest()->limit(10)->get();
        $storyNews = Story::latest()->limit(10)->get();
        $pageTops = Page::orderBy('view', 'desc')->take(10)->get();

        return view('admin.dashboards.dashboard', compact('turnOvers', 'userVip', 'revenueToday','reChargeToday','userRegisterToday','orderToday','goldGameToday','winGameToday','storyToday','withdrawToday','orderNews','goldGiftNews','storyNews','pageTops', 'createdChapters'));
    }
